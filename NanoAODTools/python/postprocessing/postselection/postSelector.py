...
parser.add_option(      '--hist_folder',        dest='hist_folder',         type=str,               default="/eos/user/a/apuglia/Tprime/regions_histo_trota/",                                     help='Folder where to save the histograms')
